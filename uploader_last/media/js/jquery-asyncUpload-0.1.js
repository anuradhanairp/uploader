...
(function($) {
    $.fn.makeAsyncUploader = function(options) {
        return this.each(function() {
            ...
            var x = '<div class="grid_4 grid_4_box2 uploading">'+
                    '<div class="brd-grid_4_box2 dropped">'+
                        ...
                        '<div class="title-create"><span class="qq-upload-file"></span>'+
                            ...
                            '</ul>'+
                        '</div>'+
                        '<div class="video"><input type="hidden" class="task_id" /><span class="qq-upload-size"></span><div class="ProgressBar"> <div>&nbsp;</div> </div><span id="'+id+'_cancel_within"><input type="button" value="Cancel"/></span></div>'+
                        '<div class="size"></div>'+
                    '</div>'+
                '</div>';
            container.append($(x));
            ...
            $("span[id$=_cancel_within] input[type='button'", container).click(function() {
                swfu.cancelUpload(null, false);
            });
